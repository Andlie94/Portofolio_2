      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex flex-row gap-4 mt-4 text-[#349667] font-bold cursor-pointer">
            <button className="active:scale-95 transition-transform" onClick={shareButton}>
              <FaShareAlt className="inline-block mr-2 active:scale-95 transition-transform" /> <p>Share</p>
            </button>
            <button className="active:scale-95 transition-transform" onClick={copyLink}>
              <FaLink className="inline-block mr-2" /> <p>Copy Link</p>
            </button>
            </div>
          </div>
        </div>
